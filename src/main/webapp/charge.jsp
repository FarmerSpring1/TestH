...
<h2>收费细项</h2>
    <form method="POST" action="Charge.do">
      <p>收费项目：<select size="1" name="name">
        <option>开户费</option>
        <option>漫游费</option>
        <option>押金</option>
        <option>入网费</option>
      ...
      <p>收费金额：<input type="text" name="money" size="20" value="10"></p>
      <p><input type="submit" value="提交" name="B1"  onclick="alert('更改成功！');"><input type="reset" value="全部重写" name="B2"></p>
    </form>
    <hr>
    <h2>业务收费</h2>
    <form method="POST" action="ChargeItem.do">
      <p>业务：<select size="1" name="item">
        <option>开户业务</option>
      </select></p>
      <p>收费项目：<input type="checkbox" name="charge" value="A" checked>开户费 
      <input type="checkbox" name="charge" value="B">漫游费 <input type="checkbox" name="charge" value="C">押金 
      <input type="checkbox" name="charge" value="D " checked>入网费 <input type="checkbox" name="charge" value="E" checked>选号费</p>
