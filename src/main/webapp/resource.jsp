...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="AddCard.do">
    <p>号码类型：<input type="Radio" name="type"  value="SIM" checked>SIM &nbsp;&nbsp;<input type="Radio" name="type"  value="UIM">UIM</p>
    <p>指定号段：从<input type="text" name="number1" size="20" value="13910000000">到<input type="text" name="number2" size="20" value="13912345678"><input type="submit" value="提交" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>
    <hr>
