...
<script type="text/javascript">
	$(function(){
		$("#number").click(function(){
			$("#div1").slideDown(800);
				$("#div1").load("GetNumber.do",{},function(){
					$("input:radio").change(function(){
						$("#number").val($(this).next().html());
  ...
  <TR vAlign=top>
    <TD height="600" bgColor=#f1f3f9>
     ...
     <form method="POST" action="NewUser.do">
      <p>手机号码：<input type="text" name="number" id="number" size="20">    <input type="button" value="确认选号"   id="btn_cilck">	</p>
      <div id="div1" style="display:none;position:absolute;width:400px;height:300px;background-color:#e6fffa">
			 <input type="button" value="关闭"   id="btn_cilck">								
	  </div>
      <p>漫游状态：<input type="radio" name="status" value="省内漫游" checked>省内漫游 <input type="radio" name="status" value="国内漫游">国内漫游 
      <input type="radio" name="status" value="国际漫游">国际漫游</p>
      <p>通话级别：<input type="radio" value="本地通话" checked name="level">本地通话 
      <input type="radio" name="level" value="国内长途">国内长途 <input type="radio" name="level" value="国际长途">国际长途</p>
      <p>客户ID：<input type="text" name="C_id" size="20" value="${id}" readonly></p>
