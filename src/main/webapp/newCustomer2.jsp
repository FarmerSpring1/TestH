...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="NewCustome2.do">
    	<input type="hidden" name="oneid" value="${c.c_ID}"  >
      <p>证件类型：<input type="text" name="type" value="${c.id_type}" size="20" readonly="readonly" ></p>
      <p>证件号码：<input type="text" name="idnumber" value="${c.id_number}"  size="20"  readonly="readonly" > </p>
      <p>姓名：<input type="text" name="T1" size="20" value="${c.c_name}"></p>
      <p>性别：<input type="radio" value="男"  name="sex" ${c.c_sex=="男"?"checked":""}>男&nbsp;&nbsp; <input type="radio" name="sex" value="女"  ${c.c_sex=="女"?"checked":""}>女</p>
      <p>生日：<input type="text" name="T3" size="20" value="${c.c_sex}"></p>
      <p>联系地址：<input type="text" name="T4" size="20" value="${c.c_address}"></p>
      <p>　</p>
