...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="NewCustome2.do">   
      ...
      <p>性别：<input type="radio"  checked name="sex" value="男">男&nbsp;&nbsp; <input type="radio" name="sex" value="女" >女</p>
      <p>生日：<input type="text" name="birth" size="20" ></p>
      <p>联系地址：<input type="text" name="address" size="20" ></p>
      <p>　</p>
